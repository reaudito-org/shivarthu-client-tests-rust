...
pub struct DepartmentFundingStruct {
    driver: WebDriver,
}

impl DepartmentFundingStruct {
    ...
    pub async fn create_post(&self) -> WebDriverResult<()> {
        self.driver
            .goto(format!(
                "{}/department-funding/create-department-fund/{}",
                WEBPAGE_URL, 1
            ))
            .await?;
    ...
    pub async fn apply_staking_period(&self) -> WebDriverResult<()> {
        ...
        self.driver
            .goto(format!(
                "{}/department-funding/apply-staking-period/{}",
                WEBPAGE_URL, 1
            ))
            .await?;
    ...
    pub async fn challenge_evidence(&self, account_cut: &str) -> WebDriverResult<()> {
        ...
        self.driver
            .goto(format!(
                "{}/department-funding/schelling-game/{}",
                WEBPAGE_URL, 1
            ))
            .await?;
    ...
    pub async fn juror_selected_check(&self, account_to_check: &str) -> WebDriverResult<()> {
        ...
        self.driver
            .goto(format!(
                "{}/department-funding-juror-selected/{}",
                WEBPAGE_URL, 1
            ))
            .await?;
