...
use crate::project_tips::project_tips_functions::ProjectTipsStruct;
use thirtyfour::prelude::*;
pub async fn project_tips_run(driver: WebDriver) -> WebDriverResult<()> {
    loop {
        ...
        match number {
            ...
            1 => {
                ...
                let project_tips = ProjectTipsStruct::new(driver.clone()).await?;
                project_tips.create_post().await?;
            }
            ...
            2 => {
                ...
                let project_tips = ProjectTipsStruct::new(driver.clone()).await?;
                project_tips.apply_staking_period().await?;
            }
            ...
            6 => {
                ...
                let project_tips = ProjectTipsStruct::new(driver.clone()).await?;
                project_tips.schelling_game_page().await?;
            }
            ...
            7 => {
                ...
                let project_tips = ProjectTipsStruct::new(driver.clone()).await?;
                project_tips.apply_juror(account_stake, "500").await?;
            }
            8 => {
                // Juror stake 2
                ...
                let project_tips = ProjectTipsStruct::new(driver.clone()).await?;
                project_tips.apply_juror(account_stake, "800").await?;
            }
            9 => {
                // Juror stake 3
                ...
                let project_tips = ProjectTipsStruct::new(driver.clone()).await?;
                project_tips.apply_juror(account_stake, "1500").await?;
            }
            10 => {
                // Juror stake 4
                ...
                let project_tips = ProjectTipsStruct::new(driver.clone()).await?;
                project_tips.apply_juror(account_stake, "2000").await?;
            }
            11 => {
                // Juror stake 5
                ...
                let project_tips = ProjectTipsStruct::new(driver.clone()).await?;
                project_tips.apply_juror(account_stake, "2500").await?;
            }
            12 => {
                // Juror stake 6
                ...
                let project_tips = ProjectTipsStruct::new(driver.clone()).await?;
                project_tips.apply_juror(account_stake, "2800").await?;
            }
            ...
            13 => {
                ...
                let project_tips = ProjectTipsStruct::new(driver.clone()).await?;
                project_tips.change_period(account).await?;
            }
            14 => {
                // Change Period
                ...
                let project_tips = ProjectTipsStruct::new(driver.clone()).await?;
                project_tips.draw_jurors("3", account_for_draw).await?;
            }
            15 => {
                // Change Period
                ...
                let account_for_draw = accounts_info["account11"]["ss58_address"].as_str().unwrap();
                let project_tips = ProjectTipsStruct::new(driver.clone()).await?;
                project_tips.draw_jurors("2", account_for_draw).await?;
            }
            16 => {
                // Change Period
            ...
            17 => {
                ...
                let project_tips = ProjectTipsStruct::new(driver.clone()).await?;
                project_tips.juror_selected_check(account_to_check).await?;
